<div id="page-secondary">
  ...
  <!--<h5>Common pages are driven by page--common.tpl.php - this is meant for single column pages, e.g. About Us page (singular) - remove after theming is complete</h5>-->
